...
// Zod schema for HourlyWeatherData
...
// Zod schema for DailyForecastData
...
export const GenerateDashboardOutputSchema = z.object({
  ...
  dressMyRunSuggestion: z.array(DressMyRunItemSchema).describe('A DETAILED, ITEMIZED list of clothing recommendations based on weather at the recommended run time. Each item must be an object with "item" (string) and "category" (string). If weather is unavailable, this should be an empty array.'),
});
